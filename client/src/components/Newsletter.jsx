...
const Newsletter = () => {
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
      ...
      <p className='md:text-lg text-gray-500/70 pb-8'>Suscribe to get the latest blog, new tech, and exclusive news.</p>
      ...
      h-12'>
        ...
        outline-none w-full rounded-r-none px-3 text-gray-500' type="text" placeholder='Enter your email_id'  required/>
