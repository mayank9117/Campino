...
const BlogList = () => {
  ...
  return (
    <div>
      <div className='flex justify-center gap-4 sm:gap my-10 relative'>
      ...
      <div className='grid gird-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:gird-cols-4 gap-8 mb-24 mx-8 sm:mx-16 xl:mx-40'>
