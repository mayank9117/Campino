...
const DashBoard = () => {
  ...
  const fetchDashboard = async()=>{
    try {
      ...
      data.success ? setDashboardData(data.dashboardData) :toast.error (data.
        message)
    } catch (error) {
  ...
  return (
    <div className = 'flex-1 p-4 md:p-10 bg-blue-50/50'>
      ...
      <div>
        ...
        <div className='relative max-w-4-xl overflow-x-auto shadow rounded-lg scrollbar-hide bg-white'>
